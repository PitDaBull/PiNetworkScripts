...
def main():
    ...
    print("\nStep 1/3: Create/ensure trustline on DISTRIBUTOR (B) to API...")
    ...
    print("\nStep 2/3: Send 100000 API from ISSUER (A) → DISTRIBUTOR (B)...")
    builder = TransactionBuilder(
    ...
    print("\nDone. Supply is NOT fixed: the issuer can mint more by paying additional API from A to B (or others).")
